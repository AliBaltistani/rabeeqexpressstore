    ...
    <div class="container top-navbar__inner">
      ...
      <div class="top-navbar__left">
        ...
        <div class="top-navbar__switchers">
          <button class="switcher-btn" @click="openLocalization" :aria-label="$t('topNav.changeLanguage')">
          ...
          <button class="switcher-btn" @click="openLocalization" :aria-label="$t('topNav.changeCurrency')">
